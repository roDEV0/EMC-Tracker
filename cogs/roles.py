...
class Roles(commands.Cog):
    ...
    @roles.sub_command(name="set-citizen", description="Set the role given to citizens of your nation", default_member_permissions=disnake.Permissions(manage_guild=True))
    ...
    @roles.sub_command(name="set-foreign", description="Set the role given to foreigners of your nation", default_member_permissions=disnake.Permissions(manage_guild=True))
