...
class Roles(commands.Cog):
    ...
    @commands.slash_command(name="roles", description="Manage roles")
    ...
    async def citizen_role(self, inter: disnake.GuildCommandInteraction, role: disnake.Role):
        update_configurations.update_configuration(context=inter, citizen_role=role.id)
    ...
    async def foreign_role(self, inter: disnake.GuildCommandInteraction, role: disnake.Role):
        update_configurations.update_configuration(context=inter, foreign_role=role.id)
